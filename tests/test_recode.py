...
#         self.path = ''
    ...
    def test_recode_parameters(self):
        ...
        df = check(meta, data, col_d, col_c)
        ...
        actual = df.values.tolist()
        expected = [
            [8255.0, 1621.0, 761.0, 860.0],
            [1621.0, 1621.0, 761.0, 860.0],
            [1669.0,    0.0,   0.0,   0.0],
            [1689.0,    0.0,   0.0,   0.0],
            [1637.0,    0.0,   0.0,   0.0],
            [1639.0,    0.0,   0.0,   0.0]]
        ...
        expected = [
            ...
            [ 297.0,   63.0,  63.0,   0.0],
            [ 397.0,   76.0,   0.0,  76.0],
            [2298.0,  458.0, 458.0,   0.0],
            [2999.0,  581.0,   0.0, 581.0],
            [ 194.0,   31.0,  31.0,   0.0],
            [ 477.0,   90.0,   0.0,  90.0],
            [ 894.0,  184.0,  184.0,  0.0],
            [ 131.0,   20.0,   0.0,  20.0],
            [   4.0,    0.0,   0.0,   0.0],
            [  91.0,   21.0,   0.0,  21.0],
            [ 104.0,   25.0,  25.0,   0.0],
        ...
        actual = df.values.tolist()
        expected = [
            [8255.0, 8255.0, 3791.0,    0.0, 4464.0],
            [ 297.0,  297.0,  297.0,    0.0,    0.0],
            [ 397.0,  397.0,    0.0,    0.0,  397.0],
            [2298.0, 2298.0, 2298.0,    0.0,    0.0],
            [2999.0, 2999.0,    0.0,    0.0, 2999.0],
            [ 194.0,  194.0,  194.0,    0.0,    0.0],
            [ 477.0,  477.0,    0.0,    0.0,  477.0],
            [ 894.0,  894.0,  894.0,    0.0,    0.0],
            [ 131.0,  131.0,    0.0,    0.0,  131.0],
            [   4.0,    4.0,    4.0,    0.0,    0.0],
            [  91.0,   91.0,    0.0,    0.0,   91.0],
            [ 104.0,  104.0,  104.0,    0.0,    0.0],
            [ 369.0,  369.0,    0.0,    0.0,  369.0]]
        self.assertSequenceEqual(actual, expected)
